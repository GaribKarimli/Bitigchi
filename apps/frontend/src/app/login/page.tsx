        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm mt-1" style={{ color: "#6b7280" }}>
              Sign in to your Bitigchi account
            </p>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 rounded-xl mb-6 transition-colors"
            style={{
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="text-xs font-medium" style={{ color: "#a0a0b0" }}>
                  Password
                </label>
                <Link
